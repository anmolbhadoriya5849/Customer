...
function CustomerPublicContent() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <main className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-24 flex-grow">
        {/* Header Section */}
      ...
      <footer className="w-full py-12 px-4 border-t border-white/5 bg-black/20">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex flex-wrap justify-center gap-8">
            ...
            <Link href="/terms" className="text-xs font-bold text-slate-400 hover:text-cyan-400 uppercase tracking-widest transition-colors">
              Terms of Service
            </Link>
            <Link href="/refunds" className="text-xs font-bold text-slate-400 hover:text-cyan-400 uppercase tracking-widest transition-colors">
              Refund Policy
            </Link>
          </div>
        </div>
